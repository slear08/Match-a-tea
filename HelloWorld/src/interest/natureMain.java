...
public class natureMain extends JPanel {
	...
	private Image adv1 = new ImageIcon(intrestMainPanel.class.getResource("/nature/strawberry-farm.jpg")).getImage().getScaledInstance(211,284, Image.SCALE_SMOOTH);
	private Image adv2  = new ImageIcon(intrestMainPanel.class.getResource("/nature/Panimahawa Ridge1.PNG")).getImage().getScaledInstance(211,284, Image.SCALE_SMOOTH);
	private Image adv3  = new ImageIcon(intrestMainPanel.class.getResource("/nature/-Apoa-Rolling-Hills.jpg")).getImage().getScaledInstance(211,284, Image.SCALE_SMOOTH);
...
//	private tugononFalls tugononFalls = new tugononFalls(); 
	...
	public natureMain() {
		...
		JLabel parag2 = new JLabel("breathtaking scenery. Explore rice terraces, come face to face with native wildlife, and chase waterfalls.");
		...
		parag2.setBounds(72, 163, 799, 24);
		add(parag2);
		
		JLabel parag1 = new JLabel("Go beyond the Philippines' beaches and into the outdoors, where you'll be surrounded by");
		...
		parag1.setBounds(106, 144, 707, 24);
		add(parag1);
		...
		JLabel titleBarracuda = new JLabel("NATURE");
		...
		titleBarracuda.setBounds(268, 78, 355, 55);
		add(titleBarracuda);
		...
		titleContent1.setBounds(52, 11, 201, 22);
		...
		titleContent2.setBounds(287, 11, 211, 22);
		...
		titleContent3.setBounds(527, 11, 211, 22);
