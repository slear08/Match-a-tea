...
public class palawanMain extends JPanel {
	...
	private Image pic1 = new ImageIcon(palawanMain.class.getResource("/destinationResPalawan/WEBSITE.jpg")).getImage().getScaledInstance(120,120, Image.SCALE_SMOOTH);
	private Image pic2 = new ImageIcon(palawanMain.class.getResource("/destinationResPalawan/Baraccuda Lake.jpg")).getImage().getScaledInstance(120,120, Image.SCALE_SMOOTH);
	private Image pic3 = new ImageIcon(palawanMain.class.getResource("/destinationResPalawan/Puerto Princesa Subteranean river.jpg")).getImage().getScaledInstance(120,120, Image.SCALE_SMOOTH);
	...
	private underGroundRiver underGroundRiver = new  underGroundRiver();
	...
	public palawanMain() {
		...
		destination3.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				destinationClicked(underGroundRiver);
			}
		});
	...
	public void destinationClicked(JPanel panel) {
		...
		underGroundRiver.setVisible(false);
