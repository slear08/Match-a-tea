...
public class tugononFalls extends JPanel {
	...
	private Image banner = new ImageIcon(agusanMain.class.getResource("/destinationResAgusan/Tugonon-Falls1.jpg")).getImage().getScaledInstance(925,284, Image.SCALE_SMOOTH);
	private Image contentImage1 = new ImageIcon(agusanMain.class.getResource("/destinationResAgusan/Tugonon-Falls1.jpg")).getImage().getScaledInstance(409, 270, Image.SCALE_SMOOTH);
	...
	public tugononFalls() {
		...
		JLabel titleBanner = new JLabel("Tugonon Falls");
